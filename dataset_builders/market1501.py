...
def load_data(path):
    train = load_subset(os.path.join(path, 'bounding_box_train'))
    query = load_subset(os.path.join(path, 'query'))
    gallery = load_subset(os.path.join(path, 'bounding_box_test'))
